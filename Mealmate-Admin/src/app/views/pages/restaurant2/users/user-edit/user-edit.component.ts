...
export class UserEditComponent implements OnInit, OnDestroy {
  ...
  createForm() {
    this.userForm = this.userFB.group({
      restaurantname: [this.user.restaurantname, Validators.required],
      owner: [this.user.owner, Validators.required],
  ...
  prepareUser(): User {
    ...
    _user.restaurantname = controls.restaurantname.value;
    _user.email = controls.email.value;
    _user.owner = controls.owner.value;
  ...
  getComponentTitle() {
    ...
    result = `Edit user - ${this.user.restaurantname}`;
    return result;
  }

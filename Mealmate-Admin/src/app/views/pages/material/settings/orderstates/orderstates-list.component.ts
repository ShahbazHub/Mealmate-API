...
@Component({
  ...
  selector: "kt-orderstates-list",
  templateUrl: "./orderstates-list.component.html",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class OrderstatesComponent implements OnInit, OnDestroy {
  // Table fields
  ...
  ngOnInit() {
    ...
    this.subheaderService.setTitle("Order States");

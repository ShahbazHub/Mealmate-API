...
@Component({
  ...
  selector: "kt-dietaries-list",
  templateUrl: "./dietaries-list.component.html",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DietariesComponent implements OnInit, OnDestroy {
  // Table fields
  ...
  ngOnInit() {
    ...
    this.subheaderService.setTitle("Dietaries");

...
//import { MaterialTableComponent } from "./data-table/material-table/material-table.component";
import { AllergensTableComponent } from "./settings/allergens/allergens-list.component";
import { OrderstatesComponent } from "./settings/orderstates/orderstates-list.component";
import { DietariesComponent } from "./settings/dietaries/dietaries-list.component";
import { MenusComponent } from "./settings/menus/menus-list.component";
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: AllergensTableComponent,
      },
      {
      ...
      {
        path: "settings/dietaries",
        component: DietariesComponent,
      },
      {
        path: "settings/menus",

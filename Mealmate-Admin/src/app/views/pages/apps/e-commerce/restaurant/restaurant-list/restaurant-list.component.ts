...
export class RestaurantListComponent implements OnInit, OnDestroy {
  ...
  editCustomer(customer: CustomerModel) {
    ...
    saveMessageTranslateParam +=
      customer.id > 0 ? "UPDATE_MESSAGE" : "ADD_MESSAGE";
    const _saveMessage = this.translate.instant(saveMessageTranslateParam);
    const _messageType =
      customer.id > 0 ? MessageType.Update : MessageType.Create;
  ...
  editRestaurant() {
    var customer = new RestaurantModel();
    customer.id = 1;
    customer.email = "a@length.com";
    customer.owner = "hamza";
    customer.restaurantname = "Monal";
    customer.restaurantname = "Islamabad";

    let saveMessageTranslateParam = "ECOMMERCE.CUSTOMERS.EDIT_RESTAURANT.";
    saveMessageTranslateParam += 1 > 0 ? "UPDATE_MESSAGE" : "ADD_MESSAGE";
    const _saveMessage = this.translate.instant(saveMessageTranslateParam);
    const _messageType = 1 > 0 ? MessageType.Update : MessageType.Create;

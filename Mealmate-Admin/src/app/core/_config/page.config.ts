export class PageConfig {
  public defaults: any = {
    ...
    restaurant: {
      page: { title: "Restaurant", desc: "" },
    },
    admin: {
      page: {
        title: "Administration",
        desc: "Restaurant Profile and It's Branches Details",
      },
    },
    qrcodes: {
      page: {
    ...
    settings: {
      allergens: {
        page: { title: "Allergens", desc: "" },
      },
      dietaries: {
        page: { title: "Dietaries", desc: "" },
      },
      options: {
        page: { title: "Menu Options", desc: "" },
      },
    },
    ngbootstrap: {
      accordion: {

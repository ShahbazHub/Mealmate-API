...
const API_CUSTOMERS_URL = "http://localhost:3013/customers";
...
export class CustomersService {
  ...
  createCustomer(customer: CustomerModel): Observable<CustomerModel> {
    ...
    return this.http.post<CustomerModel>(API_CUSTOMERS_URL, customer, {
      headers: httpHeaders,
    });
  }
  ...
  getAllCustomers(): Observable<CustomerModel[]> {
    console.log("In Customer Sevice E-Commerece");

...
export enum CustomerActionTypes {
  ...
  RestaurantUpdated = "[Edit Restaurant Dialog] Restaurant Updated",
  RestaurantOnServerCreated = "[Edit Customer Dialog] Restaurant On Server Created",
}
...
export class RestaurantOnServerCreated implements Action {
  readonly type = CustomerActionTypes.RestaurantOnServerCreated;
  constructor(public payload: { customer: RestaurantModel }) {}
}
...
export class RestaurantUpdated implements Action {
  readonly type = CustomerActionTypes.RestaurantUpdated;

  constructor(
    public payload: {
      partialCustomer: Update<RestaurantModel>; // For State update
      customer: RestaurantModel; // For Server update (through service)
    }
  ) {}
}
